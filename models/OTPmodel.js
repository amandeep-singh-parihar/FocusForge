...
async function sendVerificationOTP(email, otp) {
	try {
		const emailBody = `
            ...
            <body>
                <div class="container">
                    ...
                    <p>Dear User,</p>
                    <p>Thank you for registering with Focus Forge. To complete your registration, please use the following One-Time Password (OTP):</p>
                    <div class="otp-code">${otp}</div>
                    <p>This OTP is valid for 5 minutes. Please do not share this OTP with anyone.</p>
                    <p>If you did not request this, please ignore this email.</p>
                    <p>Thanks,</p>
                    <p>The Focus Forge Team</p>
                </div>
                <div class="footer">
                    &copy; ${new Date().getFullYear()} Focus Forge. All rights reserved.
                </div>
            </body>
            </html>
        `;
		...
		const mailResponse = await mailSender(
			email,
			'Focus Forge - Verification OTP', // A more descriptive subject
